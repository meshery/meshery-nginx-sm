...
//	k8s.io/apimachinery => k8s.io/apimachinery v0.23.5 // prevent updates until k8s.io deps issues are resolved
)

require (
	github.com/google/uuid v1.3.0
	github.com/layer5io/meshery-adapter-library v0.6.2
